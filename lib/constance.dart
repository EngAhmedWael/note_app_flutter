...
class AppConstants {
  ...
  static height26(context) {
    var height = MediaQuery.of(context).size.height * .028;
    return height;
  }
  ...
  static height60(context) {
    var height = MediaQuery.of(context).size.height * .085;
    return height;
  }

  static height100(context) {
    var height = MediaQuery.of(context).size.height * .095;
    return height;
  }
